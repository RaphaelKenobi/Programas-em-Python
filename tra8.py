...
# função principal para receber dados do usuario
...
def main():
    ...
    melhor_combinacao = calcular_melhor_combinacao_desconto(
        d1, vpd, d2, vpd2, d3, vpd3, lista1) #chamada da função
